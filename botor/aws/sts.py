...
@rate_limited()
def boto3_cached_conn(service, service_type='client', future_expiration_minutes=15, account_number=None, assume_role=None, session_name='botor', region='us-east-1'):
    """
    ...
    :param session_name: Session name to attach to requests. [Default 'botor']
    ...
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            kwargs[service_type] = boto3_cached_conn(
                ...
                session_name=kwargs.pop('session_name', 'botor'),
